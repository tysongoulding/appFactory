# Application Agent Rule Set (Android Instance)
...
4.  **Secrets & Variables**: All endpoints and key strings must bind to Vault values at build or runtime. Zero hardcoding.
